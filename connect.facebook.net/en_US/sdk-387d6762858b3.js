/*1682829236,,JIT Construction: v1007403632,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("FBEventsUtils", [], (function(a, b, c, d, e, f) {
                    ...
                    function a(a, b, c) {
                        var d = g ? "on" + b : b;
                        b = function b() {
                            g ? a.detachEvent && a.detachEvent(d, b) : a.removeEventListener(d, b, !1), c()
                        };
                        g ? a.attachEvent && a.attachEvent(d, b) : a.addEventListener(d, b, !1)
                    }
                    f.listenOnce = a
                }), 66);
                __d("FBPixelEndpoint", ["invariant", "FBEventsParamList", "FBEventsUtils"], (function(a, b, c, d, e, f, g, h) {
                    "use strict";
                ...
                __d("FBAppEvents", ["ApiClient", "FBPixelEndpoint"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    var h = Object.freeze({
                    ...
                    function u(a, b, d) {
                        ...
                        c("sdk.Runtime").isCanvasEnvironment() ? B(e, a, b, d) : C(e, a, b, d)
                    }
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Extensions", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Native", "sdk.Popup", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.XD", "sdk.api", "sdk.fbt", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.openMessenger"], (function(a, b, c, d, e, f, g) {
                    ...
                    function k(a) {
                        ...
                        g = Object.keys(ES("Object", "assign", !1, a.params.response_type ? c("createObjectFrom")(a.params.response_type.split(",")) : {}, g)).join(",");
                    ...
                    a = c("sdk.XFBML.Comments").extend({
                        constructor: function(a, b, e, f) {
                            d("sdk.DOM").addCss(a, "fb_comments_count_zero"), f.count = 1, this.parent(a, b, "comments", f), this.subscribe("xd.comment_count", function(b) {
                                ...
                                d("sdk.DOM").html(a, c("sprintf")('<span class="fb_comments_count">%s</span>', b.count));
                ...
                __d("performanceAbsoluteNow", ["performance"], (function(a, b, c, d, e, f, g) {
                    ...
                    if (c("performance").now && c("performance").timing && c("performance").timing.navigationStart) {
                        ...
                        if (a != null && a && c("performance").now && c("performance").timeOrigin) {
                            a = c("performance").timeOrigin;
                            return c("performance").now() + a
                        }
                        return h()
                    };
                    b.setFallback = a;
                        ...
                        e.render = function(a) {
                            ...
                            c("CORSRequest").execute(a, "get", this.params, function(a) {
                                ...
                                if (b.$ChatDOMFacade9 === "none") {
                                    ...
                                    d("sdk.DOM").html(b.$ChatDOMFacade3, b.$ChatDOMFacade17(e))
                                }
                        ...
                        e.$ChatDOMFacade20 = function() {
                            ...
                            if (this.$ChatDOMFacade9 === "none") {
                                ...
                                if (this.$ChatDOMFacade10 === "none") {
                                    ...
                                    d("sdk.DOM").html(this.$ChatDOMFacade3.children[0], this.$ChatDOMFacade22(b, a) + this.$ChatDOMFacade3.children[0].innerHTML);
                                ...
                                } else d("sdk.DOM").html(this.$ChatDOMFacade3.children[0].children[0], a)
                            }
                    ...
                    a = function(a) {
                        ...
                        e.$CustomerChat21 = function(a) {
                            ...
                            var e = a.frameName,
                                ...
                                i = document.createElement("div");
                            f != null && (d("sdk.DOM").html(i, f), ES("Object", "assign", !1, i.style, h), i.style.boxShadow = "none", d("sdk.Content").append(i, g.contentRoot));
                            var j = "blank_" + e;
                ...
                __d("sdk.XFBML.CustomerChatWrapper", ["$InternalEnum", "CORSRequest", "UrlMap", "sdk.Observable", "sdk.XFBML.ChatDOM"], (function(a, b, c, d, e, f, g) {
                    a = b("$InternalEnum")({
                        SHOW: "SHOW",
                        HIDE: "HIDE",
                    ...
                    var h = function(b) {
                        ...
                        e.process = function() {
                            var a = this,
                                b = d("UrlMap").resolve("social_plugin") + "/new_domain_gating/";
                            c("CORSRequest").execute(b, "get", {
                                page_id: this.$CustomerChatWrapper5.page_id,
                                endpoint: this.$CustomerChatWrapper4
                            }, function(b) {
                                a.$CustomerChatWrapper5.should_use_new_domain = b.should_use_new_domain, a.$CustomerChatWrapper1 = new(c("sdk.XFBML.ChatDOM"))(a.$CustomerChatWrapper2, a.$CustomerChatWrapper3, a.$CustomerChatWrapper4, a.$CustomerChatWrapper5), a.$CustomerChatWrapper1.subscribe("render", function() {
                                    a.inform("render")
                    ...
                    function a() {
                        ...
                        function b(b) {
                            var d = h.getEntriesByType("resource").filter(function(d) {
                                ...
                                e = d.length >= 1;
                            e || (d = h.getEntriesByType("resource").filter(function(a) {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1007403632","namespace":"FB","message":"' + e.message + '"}}');
