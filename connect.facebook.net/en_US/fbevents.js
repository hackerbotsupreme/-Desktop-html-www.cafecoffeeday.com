...
(function(a, b, c, d) {
    ...
    (function() {
                    ...
                    a = function() {
                        function a() {
                            ...
                            this._configStore = (b = {
                                ...
                                defaultCustomData: {},
                                estRuleEngine: {}
                            }, l(b, "defaultCustomData", {}), l(b, "browserProperties", {}), b)
                        }
                        h(a, [{
                            key: "set",
                            value: function(a, b, c) {
                                ...
                                this._configStore[b][a] = y[b] != null ? y[b](c) : c
                            }
                        }, {
                            key: "setExperimental",
                            value: function(a) {
                            ...
                            key: "get",
                            value: function(a, b) {
                                return this._configStore[b][a != null ? a : x]
                            }
                        }, {
        ...
        f.ensureModuleRegistered("signalsFBEventsSendEvent", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var n = f.getFbeventsModules("signalsFBEventsSendXHRWithRetry"),
                    ...
                    var s = a.some,
                        t = f.getFbeventsModules("SignalsFBEventsNetworkConfig");
                    f.getFbeventsModules("generateUUID");
                    a = f.getFbeventsModules("SignalsFBEventsExperimentNames");
                    a.BATCHING_EXPERIMENT;
                    a.DISALLOW_PII_ON_STRICT_NON_SUBMIT;
                    var u = a.NETWORK_RETRY_EXPERIMENT;
                    a.SEND_BEACON_STRING_EXPERIMENT;
                    ...
                    function z(a, b, c) {
                        a.replaceEntry("rqm", c), n(a, t.ENDPOINT, b, 0)
                    }

                    function A(a) {
                        var f = typeof XMLHttpRequest !== "undefined" && "withCredentials" in new XMLHttpRequest(),
                            g = q.trigger(a);
                        if (s(g, function(a) {
                                return a
                            })) return;
                        ...
                        c.trigger(a.id, f);
                        var j = !p(),
                            k = Object.prototype.hasOwnProperty.call(a, "customData") && typeof a.customData !== "undefined" && a.customData !== null;
                        k || (a.customData = {});
                        d.isInTest(e);
                        if (j && h === w) {
                            if (i) {
                                z(f, "POST", "SB");
                                b.trigger("XHRPOST", f, g);
                                return
                            }
                            if (l(f)) {
                                b.trigger("BEACON", f, g);
                                return
                            }
                        }
                        if (i) {
        ...
        f.ensureModuleRegistered("signalsFBEventsSendXHRWithRetry", function() {
            return function(g, h, i, j) {
                var k = {
                    exports: {}
                };
                ...
                (function() {
                    ...
                    function g(a, f, h, i) {
                        ...
                        j.withCredentials = !0;
                        var k;
                        h == "GET" ? k = f + "?" + a.toQueryString() : k = f;
                        j.open(h, k);
                        j.onreadystatechange = function() {
                            if (j.readyState === e.DONE && j.status !== 200) {
                                if (i >= d) {
                                    b(new Error("Reached the max number of retries for " + h));
                                    return
                                }
                                setTimeout(function() {
                                    g(a, f, h, i + 1)
                        ...
                        h == "POST" ? j.send(a.toFormData()) : j.send()
                    }
                    k.exports = g
                })();
                return k.exports
                    ...
                    function la(a) {
                        ...
                        switch (a) {
                            ...
                            case "trackSingleOnly":
                                ...
                                var I = q.validateMetadata(a);
                                I.error && N(I.error);
                                I.warnings && I.warnings.forEach(function(a) {
                                    N(a)
                                });
                                Q.call(U, H) ? U[H].trackSingleOnly = G : N({
                                    metadataValue: a,
                                    pixelID: H,
                                ...
                                break;
                            default:
                                var J = W.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                                    K = J != null && J.dataProcessingOptions.includes("LDU"),
                                    L = c[0],
                                    M = c[1];
